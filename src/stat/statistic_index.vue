...
<template>
  <div class="page">
    ...
    <view class="body">
      ...
      <view v-else>
        <ul>
          <li v-for='statistic in statistics' :key="statistic.eventKey" @click="toDetail($event,statistic)">
            <view class="item">
              <view class="content">
                <view class="item">
                  <p>时间：</p>
    ...
    <view class="tabBar">
      <block>
        <view class="tabBar-item" @click="$router.replace({path:'/pages/main'})">
          <view>
            <image class="icon" src='/static/settings.png'></image>
          </view>
          <view class="tabBartext">主页</view>
        </view>
        <view class="tabBar-item">
          <view>
            <image class="icon" src='/static/calendar.png'></image>
          </view>
          <view class="tabBartext">时间统计</view>
        </view>
        <view class="tabBar-item" @click="$router.push({path:'/stat/statistic_add'})">
          <view>
            <image class="icon" src='/static/add.png'></image>
          </view>
